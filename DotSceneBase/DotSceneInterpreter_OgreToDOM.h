...
protected:
	...
	void RecursiveNodeTreeWalkthrough(
	        Ogre::Node* actualSceneNode,
...
public:
	...
	// Inheritable methods
	virtual ScenePrototype* Interpretation(
	        wxString PrototypeNativeName,
	        DotSceneBaseConfiguration*
	        Configuration ) = 0;
};
