...
void OViSEInterpreter_DOMToOgre_DotSceneV1_0_0::Interpretation_Node(	xercesc::DOMElement* DOMElement_node,
...
void OViSEInterpreter_DOMToOgre_DotSceneV1_0_0::Interpretation_Entity(	xercesc::DOMElement* DOMElement_entity,
...
Ogre::Vector4 OViSEInterpreter_DOMToOgre_DotSceneV1_0_0::Interpretation_Vector4(xercesc::DOMElement* DOMElement_Vector4)
{
...
Ogre::Quaternion OViSEInterpreter_DOMToOgre_DotSceneV1_0_0::Interpretation_Quaternion(xercesc::DOMElement* DOMElement_Quaternion)
{
...
bool OViSEInterpreter_DOMToOgre_DotSceneV1_0_0::IsValidFormatVersion(xercesc::DOMDocument* DOMRepresentationOfScene)
{
	return OViSEInterpreter_DOMToOgre_DotSceneAbstract::GetVersionString(DOMRepresentationOfScene).IsSameAs(ToWxString("1.0.0"));
}
bool OViSEInterpreter_DOMToOgre_DotSceneV1_0_0::Interpretation(	xercesc::DOMDocument* DOMRepresentationOfScene,
