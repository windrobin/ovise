...
wxString OViSEInterpreter_OgreToDOM_DotSceneAbstract::GetVersionString() { return VersionString; }
OViSEInterpreter_OgreToDOM_DotSceneAbstract::~OViSEInterpreter_OgreToDOM_DotSceneAbstract(void) { }
bool OViSEInterpreter_OgreToDOM_DotSceneAbstract::Interpretation_OgreScene(	wxString NotUniquePrototypeName,
																			...
																			OViSEDotSceneManagerConfiguration* Configuration)
{
	...
	// Create DOMDocument
	xercesc::DOMDocument* TempDOMDocument = OViSEInterpreter_OgreToDOM_DotSceneAbstract::Implementation->createDocument(0, ToXMLString("scene"), 0); // Don't use any more, but remember: "(XMLString::transcode(this->mDestinationURI.c_str()), XMLString::transcode("scene"), 0)"
	
	// Create new Prototype
	this->Prototype = new OViSEScenePrototype(this->UniquePrototypeName, TempDOMDocument);
...
void OViSEInterpreter_OgreToDOM_DotSceneAbstract::Interpretation_Nodes(xercesc::DOMElement* SceneElement)
{
...
void OViSEInterpreter_OgreToDOM_DotSceneAbstract::RecursiveNodeTreeWalkthrough(	Ogre::Node* SomeNode,
