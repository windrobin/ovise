...
void OViSEInterpreter_OgreToDOM_DotSceneV1_0_0::SetVersionString(wxString VersionString) { this->VersionString = VersionString; }
OViSEInterpreter_OgreToDOM_DotSceneV1_0_0::OViSEInterpreter_OgreToDOM_DotSceneV1_0_0(void)
{
}
...
xercesc::DOMElement* OViSEInterpreter_OgreToDOM_DotSceneV1_0_0::Interpretation_Node(Ogre::SceneNode* actualSceneNode)
{
...
xercesc::DOMElement* OViSEInterpreter_OgreToDOM_DotSceneV1_0_0::Interpretation_Camera(Ogre::Camera* SomeCamera)
{
...
xercesc::DOMElement* OViSEInterpreter_OgreToDOM_DotSceneV1_0_0::Interpretation_Entity(Ogre::Entity* SomeEntity)
{
...
xercesc::DOMElement* OViSEInterpreter_OgreToDOM_DotSceneV1_0_0::Interpretation_Light(Ogre::Light* SomeLight)
{
...
xercesc::DOMElement* OViSEInterpreter_OgreToDOM_DotSceneV1_0_0::Interpretation_Position(Ogre::Vector3 NodePosition)
{
...
xercesc::DOMElement* OViSEInterpreter_OgreToDOM_DotSceneV1_0_0::Interpretation_Quaternion(Ogre::Quaternion NodeQuaternion)
{
...
xercesc::DOMElement* OViSEInterpreter_OgreToDOM_DotSceneV1_0_0::Interpretation_Scale(Ogre::Vector3 NodeScale)
{
...
xercesc::DOMElement* OViSEInterpreter_OgreToDOM_DotSceneV1_0_0::Interpretation_DiffuseColour(Ogre::ColourValue DiffuseColour)
{
...
xercesc::DOMElement* OViSEInterpreter_OgreToDOM_DotSceneV1_0_0::Interpretation_SpecularColour(Ogre::ColourValue SpecularColour)
{
...
bool OViSEInterpreter_OgreToDOM_DotSceneV1_0_0::IsValidFormatVersion(wxString VersionStringForExport)
{
	return VersionStringForExport.IsSameAs(ToWxString("1.0.0"));
}
OViSEScenePrototype* OViSEInterpreter_OgreToDOM_DotSceneV1_0_0::Interpretation(	wxString NotUniquePrototypeName,
