...
#else
    if (value == "PF_UNKNOWN")		{ this->_PixelFormat = PF_UNKNOWN;		match = true; }
    if (value == "PF_L8")			{ this->_PixelFormat = PF_L8;			match = true; }
    if (value == "PF_BYTE_L")		{ this->_PixelFormat = PF_BYTE_L;		match = true; }
    if (value == "PF_L16")			{ this->_PixelFormat = PF_L16;			match = true; }
    if (value == "PF_SHORT_L")		{ this->_PixelFormat = PF_SHORT_L;		match = true; }
    if (value == "PF_A8")			{ this->_PixelFormat = PF_A8;			match = true; }
    if (value == "PF_BYTE_A")		{ this->_PixelFormat = PF_BYTE_A;		match = true; }
    if (value == "PF_A4L4")			{ this->_PixelFormat = PF_A4L4;		match = true; }
    if (value == "PF_BYTE_LA")		{ this->_PixelFormat = PF_BYTE_LA;		match = true; }
    if (value == "PF_R5G6B5")		{ this->_PixelFormat = PF_R5G6B5;		match = true; }
    if (value == "PF_B5G6R5")		{ this->_PixelFormat = PF_B5G6R5;		match = true; }
    if (value == "PF_R3G3B2")		{ this->_PixelFormat = PF_R3G3B2;		match = true; }
    if (value == "PF_A4R4G4B4")		{ this->_PixelFormat = PF_A4R4G4B4;	match = true; }
    if (value == "PF_A1R5G5B5")		{ this->_PixelFormat = PF_A1R5G5B5;	match = true; }
    if (value == "PF_R8G8B8")		{ this->_PixelFormat = PF_R8G8B8;		match = true; }
    if (value == "PF_B8G8R8")		{ this->_PixelFormat = PF_B8G8R8;		match = true; }
    if (value == "PF_A8R8G8B8")		{ this->_PixelFormat = PF_A8R8G8B8;	match = true; }
    if (value == "PF_A8B8G8R8")		{ this->_PixelFormat = PF_A8B8G8R8;	match = true; }
    if (value == "PF_B8G8R8A8")		{ this->_PixelFormat = PF_B8G8R8A8;	match = true; }
    if (value == "PF_R8G8B8A8")		{ this->_PixelFormat = PF_R8G8B8A8;	match = true; }
    if (value == "PF_X8R8G8B8")		{ this->_PixelFormat = PF_X8R8G8B8;	match = true; }
    if (value == "PF_X8B8G8R8")		{ this->_PixelFormat = PF_X8B8G8R8;	match = true; }
    if (value == "PF_BYTE_RGB")		{ this->_PixelFormat = PF_BYTE_RGB;	match = true; }
    if (value == "PF_BYTE_BGR")		{ this->_PixelFormat = PF_BYTE_BGR;	match = true; }
    if (value == "PF_BYTE_BGRA")	{ this->_PixelFormat = PF_BYTE_BGRA;	match = true; }
    if (value == "PF_BYTE_RGBA")	{ this->_PixelFormat = PF_BYTE_RGBA;	match = true; }
    if (value == "PF_A2R10G10B10")	{ this->_PixelFormat = PF_A2R10G10B10;	match = true; }
    if (value == "PF_A2B10G10R10")	{ this->_PixelFormat = PF_A2B10G10R10;	match = true; }
    if (value == "PF_DXT1")			{ this->_PixelFormat = PF_DXT1;		match = true; }
    if (value == "PF_DXT2")			{ this->_PixelFormat = PF_DXT2;		match = true; }
    if (value == "PF_DXT3")			{ this->_PixelFormat = PF_DXT3;		match = true; }
    if (value == "PF_DXT4")			{ this->_PixelFormat = PF_DXT4;		match = true; }
    if (value == "PF_DXT5")			{ this->_PixelFormat = PF_DXT5;		match = true; }
    if (value == "PF_FLOAT16_R")	{ this->_PixelFormat = PF_FLOAT16_R;	match = true; }
    if (value == "PF_FLOAT16_RGB")	{ this->_PixelFormat = PF_FLOAT16_RGB;	match = true; }
    if (value == "PF_FLOAT16_RGBA")	{ this->_PixelFormat = PF_FLOAT16_RGBA;match = true; }
    if (value == "PF_FLOAT32_R")	{ this->_PixelFormat = PF_FLOAT32_R;	match = true; }
    if (value == "PF_FLOAT32_RGB")	{ this->_PixelFormat = PF_FLOAT32_RGB;	match = true; }
    if (value == "PF_FLOAT32_RGBA")	{ this->_PixelFormat = PF_FLOAT32_RGBA;match = true; }
    if (value == "PF_FLOAT16_GR")	{ this->_PixelFormat = PF_FLOAT16_GR;	match = true; }
    if (value == "PF_FLOAT32_GR")	{ this->_PixelFormat = PF_FLOAT32_GR;	match = true; }
    if (value == "PF_DEPTH")		{ this->_PixelFormat = PF_DEPTH;		match = true; }
    if (value == "PF_SHORT_RGBA")	{ this->_PixelFormat = PF_SHORT_RGBA;	match = true; }
    if (value == "PF_SHORT_GR")		{ this->_PixelFormat = PF_SHORT_GR;	match = true; }
    if (value == "PF_SHORT_RGB")	{ this->_PixelFormat = PF_SHORT_RGB;	match = true; }
    if (value == "PF_COUNT")		{ this->_PixelFormat = PF_COUNT;		match = true; }

	if (!match) this->_PixelFormat = PF_UNKNOWN;
#endif
}
...
#else
	this->set_ShadowIndex(PF_UNKNOWN);
#endif
}
