...
namespace dotSceneObjects
{
	...
	/**
	 * This class represents the x, y and z values of an 3D-vector, interpreted as common up-vector.
	 * Used in billboardSet.
	 * It inherits from dotScene3D.
	 */
    class dotSceneCommonUpVector : public dotScene3D
    {     
	public:
		/**
		 * Simple constructor.
		 */
		dotSceneCommonUpVector();
		 ...
		 */
		dotSceneCommonUpVector(std::string str_x, std::string str_y, std::string str_z);
		 ...
		 */
		dotSceneCommonUpVector(double double_x, double double_y, double double_z);
    };
}
