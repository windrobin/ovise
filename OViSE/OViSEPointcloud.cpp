...
OViSEPointcloud::OViSEPointcloud(const std::string& name, const std::string& resourcegroup, const int numpoints, float *parray, float *carray)
{
...
void OViSEPointcloud::updateVertexPositions(int size, float *points)
{
...
void OViSEPointcloud::updateVertexColours(int size, float *colours)
{
