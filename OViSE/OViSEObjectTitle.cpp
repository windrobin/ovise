...
OViSEObjectTitle::~OViSEObjectTitle(void)
{
...
void OViSEObjectTitle::setTitle(const String& title)
{
	textArea->setCaption(title);
	textDim = getTextDimensions(title);
	container->setDimensions(textDim.x, textDim.y);
...
Vector2 OViSEObjectTitle::getTextDimensions(String text)
{
