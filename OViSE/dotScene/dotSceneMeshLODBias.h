...
namespace dotSceneObjects
{
	 ...
	 */
    class dotSceneMeshLODBias : virtual public dotSceneObject 
    {
	private:
	...
	public:
		 ...
		 */
		dotSceneMeshLODBias(std::string str_Factor, std::string  str_MaxDetailIndex, std::string str_MinDetailIndex);
		 ...
		 */
		dotSceneMeshLODBias(std::string str_Factor, double double_MaxDetailIndex, double double_MinDetailIndex);
    };
}
