...
namespace dotSceneObjects
{
	 ...
	 */
    class dotSceneColour : virtual public dotSceneObject 
    {
	private:
	...
	public:
		...
		void set_r(std::string value);	/**< Set-method for property r. @param value Value in std::string-format. Will be parsed to double. */
		void set_g(std::string value);	/**< Set-method for property g. @param value Value in std::string-format. Will be parsed to double. */
		void set_b(std::string value);	/**< Set-method for property b. @param value Value in std::string-format. Will be parsed to double. */
		 ...
		 */
		dotSceneColour(dotSceneEnums::dotSceneElementTags incomingTag); 
		 ...
		 */
		dotSceneColour(dotSceneEnums::dotSceneElementTags incomingTag, std::string str_r, std::string str_g, std::string str_b);
		 ...
		 */
		dotSceneColour(dotSceneEnums::dotSceneElementTags incomingTag, double double_r, double double_g, double double_b);
    };
}
