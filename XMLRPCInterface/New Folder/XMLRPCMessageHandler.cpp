...
int XMLRPCMessageHandler::HandleRequest(const std::string& _content, HTTPReply& _reply)
{
...
{
    std::cout << " > handling html request" << std::endl;
}
...
int XMLRPCMessageHandler::checkHTTPHeader(const std::string& _header)
{
    ...
    m_requestType = trimm(m_requestType);
